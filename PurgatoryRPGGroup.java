public class PurgatoryRPGGroup
{
   public static void main( String[] args)
   {
      ...
      StdDraw.text(.5, .5, "Click any where to begin");
      ...
      for(int i = 0; i < questRepeat.length; i++)
      {
         question = i;  //(int)(Math.random() * 6 + 1);
   ...
   public static int Questions(int playerScore, int question)//change to return playerScore
   {
      ...
      {
         StdDraw.text(.5, .55, "You watch them weap before they fade away into");
      ...
      if( optionSub == 1)
      {
         ...
         StdDraw.text(.5, .5, "your kindness as you dissapear into");
      ...
      {  
         ...
         {
           StdDraw.text(.5, .6, "You infrom them of this and then");
      ...
      StdDraw.text(.5, .85, "is jsut a small creek. You could easily walk");
      ...
      StdDraw.text(.5, .28, "Begrudginly"); // option 2
      ...
      if( optionSub == 1)
      {
         StdDraw.text(.5, .6, "You drop them onto the oppisite bank with a loud, NO,");
      ...
      if( optionSub == 2)
      {
         StdDraw.text(.5, .7, "You put them down before going back and retrieving thier");
         StdDraw.text(.5, .66, "house boat, wondering if they actually know how to");
         ...
         StdDraw.text(.5, .5, "thank you as you dissapear back into the mist.");
         StdDraw.text(.5, .4, "Next");
      ...
      if( optionSub == 3)
      {
         ...
         StdDraw.text(.5, .66, "bank and pickng up their little house boat.");
         ...
         StdDraw.text(.5, .52, "incedents like this. They offer great thanks before");
      ...
      StdDraw.text(.5, .20, "your as hungry");
      ...
      if(optionSub == 1)
      {
         ...
         StdDraw.text(.5, .5, "an awful like growling as you contiune into the mist");
         StdDraw.text(.5, .4, "Next");
      ...
      StdDraw.text(.5, .16, "your hungry too."); 
      ...
      if(optionSub == 1)
      {
         ...
         StdDraw.text(.5, .6, "a peice. They smile up at you and as they begin to fade");
      ...
      {       
         StdDraw.text(.5, .65, "You split the bread, giving your self a small peice");
         StdDraw.text(.5, .6, "for your troubles, giving to equally small peices to");
      ...
      StdDraw.text(.5, .85,"you realize that you are at an impase.");   
      ...
      if(optionSub == 1)
      {
         StdDraw.text(.5, .6, "Your self preservation insticts kick in and you");
         StdDraw.text(.5, .55, "turn your back on the weird multi dimensional door.");
      ...
      {       
         StdDraw.text(.5, .7, "You reach for the door knob, and throw the door open!");
         ...
         StdDraw.text(.5, .5, "like an eternity of running it dissapers and leaves you");
      ...
      if( optionSub == 2)
      {
         StdDraw.text(.5, .55, "He says that for everthing that is taken out something");
      ...
      StdDraw.text(.5, .85, "How do you procede?");
      ...
      if( optionSub == 1)
      {
         ...
         StdDraw.text(.5, .5, "as you miander into the mist.");
         StdDraw.text(.5, .4, "Next");    
      ...
      if( optionSub == 2)
      {
         ...
         StdDraw.text(.5, .54, "The kid speaks up, you could risk you chances");
      ...
      if( optionSub == 2)
      {
         StdDraw.text(.5, .58, "You reach into the (surpirsingly deep) puddle and");
         StdDraw.text(.5, .54, "pull the toy from its depths. You give it to the");
         StdDraw.text(.5, .5, "boy whos face lights up like the 4th of July and");
      ...
      if(optionSub == 1)
      {
         StdDraw.text(.5, .58, "You leave  the dogs to their buisness and"); 
         StdDraw.text(.5, .54, "walk into the mist the dog's growls still");
         StdDraw.text(.5, .5, "fresh in you ears.");
         StdDraw.text(.5, .4, "Next");
      }
      ...
      StdDraw.text(.5, .85, "spinging around in a cricle, growling at each other");
      ...
      while( !done)
      {
        ...
        if( optionSub == 1)
        {
        StdDraw.text(.5,.58,"Before you can decide a dog lundges at you");
      ...
      StdDraw.text(.2,.16,"like the righ way");
      ...
      if(optionSub == 2)
      {
        ...
        StdDraw.text(.5, .5, "dice and dissapear. You don't waste any time");
      ...
      if( optionSub == 1)
      {
       StdDraw.text(.5, .6, "You walk away from the two squabling creatures caring");
      ...
      while( !done) 
      {
       ...
       if( optionSub == 1)
       {
         ...
         StdDraw.text(.5, .5, "but your self preservation instincs are too strong.");
         StdDraw.text(.5, .4, "Next");
       ...
       if( optionSub == 2)
       {
         ...
         StdDraw.text(.5, .5, "the cat and squirrel still squabling before they dissaper in the mist.");
         StdDraw.text(.5, .4, "Next");
       }
   ...
   public static int Endings(int playerScore)
   {
      ...
      if( optionSub == 2)
      {
         ...
         StdDraw.text(.5, .56, "and at the very last second transforms into a horrifiying");
      ...
      else if ((playerScore < -1) && (playerScore > 90)) //to hell
      {
   ...
   else if ((playerScore > 1) && (playerScore < 90)) //to heaven
      {
